...
GameManager.prototype.captureState = function () {
  var self = this
  var _previousState

  setInterval(function () {
    var f = this.storageManager.getGameState()
    this.remoteSenderManager.send(gameStateSerializer.bind(this, _previousState)())
    this.moves = []
    _previousState = f
  }.bind(this), this.sendInterval)
  _previousState = this.storageManager.getGameState()
}
...
function gameStateSerializer (state) {
  ...
  */
  ...
  message.push(state['score'])
  message.push(state['over'])
  message.push(state['won'])
  message.push(state['keepPlaying'])
  return message
}
